...
import com.acasadocogumelo.cogumelonoticias.lib.ColorPicker;
...
public class ColorFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (preferences.getInt("lastDefault", 1) == 1) {
			...
			editor.commit();
			((AppCompatActivity)getActivity()).getSupportActionBar().setBackgroundDrawable(getActivity().getResources().getDrawable(R.drawable.splash_bg));
