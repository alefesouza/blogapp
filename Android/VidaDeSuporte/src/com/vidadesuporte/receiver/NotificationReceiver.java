package com.vidadesuporte.receiver;
...
import com.vidadesuporte.activity.SplashScreen;
...
public class NotificationReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if (action.equals("com.vidadesuporte.UPDATE_STATUS")) {
				...
				if (!receivedTitle.equals("")) {
					if (preferences.getInt("count", 0) == 1) {
						...
						NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
							...
							.setAutoCancel(true)
							.setSound(Uri.parse("android.resource://com.vidadesuporte/raw/ringtone"))
						...
						Intent resultIntent = new Intent(context, com.vidadesuporte.activity.SplashScreen.class);
						...
						stackBuilder.addParentStack(com.vidadesuporte.activity.SplashScreen.class);
