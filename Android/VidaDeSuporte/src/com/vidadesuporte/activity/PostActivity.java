...
import com.vidadesuporte.adapter.TagAdapter;
import com.vidadesuporte.lib.CustomLinkMovementMethod;
import com.vidadesuporte.lib.JSONParser;
import com.vidadesuporte.other.CustomTextView;
...
public class PostActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		com.vidadesuporte.activity.FragmentActivity.ActionBarColor(PostActivity.this, "");
		...
		fabcomment.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(PostActivity.this, com.vidadesuporte.activity.CommentsActivity.class);
					...
					try {
						...
						for (int i = 0; i < tagarray.size(); i++) {
							...
							tagtext.setOnClickListener(new OnClickListener() {
								@Override
								public void onClick(View v) {
									Intent intent = new Intent(PostActivity.this, com.vidadesuporte.activity.FragmentActivity.class);
