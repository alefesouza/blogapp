...
import com.acasadocogumelo.cogumelonoticias.adapter.ListAdapter;
...
public class CategoriasFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, 	Bundle savedInstanceState) {
		...
		firstUrl = Other.defaultUrl + "allcategs.php?id=" + getString(R.string.blogid) + "&domain=" + getString(R.string.sitename);
