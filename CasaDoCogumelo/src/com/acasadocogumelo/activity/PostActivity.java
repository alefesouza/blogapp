...
import com.acasadocogumelo.activity.FragmentActivity;
import com.acasadocogumelo.adapter.TagAdapter;
import com.acasadocogumelo.lib.CustomLinkMovementMethod;
import com.acasadocogumelo.lib.JSONParser;
import com.acasadocogumelo.other.CustomTextView;
...
public class PostActivity extends ActionBarActivity implements ObservableScrollViewCallbacks {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		com.acasadocogumelo.activity.FragmentActivity.ActionBarColor(PostActivity.this, "");
		...
		fabcomment.setOnClickListener(new View.OnClickListener() {
			@Override public void onClick(View v) {
				if(Build.VERSION.SDK_INT == 10) {
					Intent intent = new Intent(PostActivity.this, com.acasadocogumelo.activity.v10.CommentsActivity.class);
					intent.putExtra("url", surl);
					startActivity(intent);
				} else {
					Intent intent = new Intent(PostActivity.this, com.acasadocogumelo.activity.CommentsActivity.class);
					intent.putExtra("url", surl);
					startActivity(intent);
				}
					...
					try {
						...
						for (int i = 0; i < tagarray.size(); i++) {
							...
							tagtext.setOnClickListener(new OnClickListener() {
								@Override
								public void onClick(View v) {
									Intent intent = new Intent(PostActivity.this, com.acasadocogumelo.activity.FragmentActivity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home:
			if (getIntent().hasExtra("fromnotification")) {
				if(Build.VERSION.SDK_INT == 10) {
					Intent intent = new Intent(PostActivity.this, com.acasadocogumelo.activity.v10.MainActivity.class);
					startActivity(intent);
				} else {
