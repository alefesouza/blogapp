package com.acasadocogumelo.cogumelonoticias.receiver;
...
import com.acasadocogumelo.cogumelonoticias.activity.SplashScreen;
...
public class NotificationReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if (action.equals("com.acasadocogumelo.cogumelonoticias.UPDATE_STATUS")) {
			...
			if (notification) {
				...
				try {
					...
					makeNotif(context, json.getString("tipo"), json.getString("id"), json.getString("barra"), json.getString("titulo"), json.getString("texto"), json.getString("titulogrande"), json.getString("textogrande"), json.getString("sumario"), json.getString("url"), json.getString("imagem"));
				} catch (JSONException e) {}
			}
		}
	}
	
	public void makeNotif(Context context, String receivedType, String receivedId, String receivedTicker, String receivedTitle, String receivedText, String receivedBigTitle, String receivedBigText, String receivedSummary, String receivedUrl, String receivedImage) {
				...
				if (!receivedTitle.equals("")) {
					if (preferences.getInt("count", 0) == 1) {
						...
						NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
							...
							.setAutoCancel(true)
							.setSound(Uri.parse("android.resource://com.acasadocogumelo.cogumelonoticias/raw/ringtone"))
						...
						Intent resultIntent = new Intent(context, com.acasadocogumelo.cogumelonoticias.activity.SplashScreen.class);
						resultIntent.putExtra("extraJson", "{ \"id\": \"" + receivedId + "\", \"titulo\": \"" + receivedText + "\", \"descricao\": \"" + receivedBigText + "\", \"imagem\": \"" + receivedImage + "\", \"url\": \"" + receivedUrl+ "\" }");
						resultIntent.putExtra("fromnotification", true);

						TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);

						stackBuilder.addParentStack(com.acasadocogumelo.cogumelonoticias.activity.SplashScreen.class);
						...
						NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
							.setSmallIcon(R.drawable.ic_launcher)
							.setTicker("Novas notícias! - " + context.getString(R.string.app_name))
