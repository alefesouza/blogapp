...
import net.aloogle.apps.acasadocogumelo.fragment. * ;
	...
	private void selectItem(int position) {
		...
		case 7:
			try {
				...
				bundle.putString("url", "http://apps.aloogle.net/blogapp/acasadocogumelo/json/main.php?label=" + URLEncoder.encode(getIntent().getStringExtra("label"), "UTF-8"));
