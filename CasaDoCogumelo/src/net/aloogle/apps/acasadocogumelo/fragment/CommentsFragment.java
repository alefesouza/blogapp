...
public class CommentsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if(Build.VERSION.SDK_INT > 10) {
			webView.setTouchInterceptionViewGroup((ViewGroup)getActivity().findViewById(R.id.container));
			webView.setScrollViewCallbacks((ObservableScrollViewCallbacks)getActivity());
		}
