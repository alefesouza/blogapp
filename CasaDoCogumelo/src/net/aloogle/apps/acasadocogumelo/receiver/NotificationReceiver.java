package net.aloogle.apps.acasadocogumelo.receiver;
...
import net.aloogle.apps.acasadocogumelo.activity.SplashScreen;

public class NotificationReceiver extends BroadcastReceiver {
	@Override
	public void onReceive(final Context context, Intent intent) {
		String action = intent.getAction();
		if (action.equals("net.aloogle.apps.acasadocogumelo.UPDATE_STATUS")) {
						...
						if (preferences.getString("receivedTitle", "").equals("")) {}
							...
							if (preferences.getInt("count", 0) == 1) {
								...
								NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
									...
									.setAutoCancel(true)
									.setSound(Uri.parse("android.resource://net.aloogle.apps.acasadocogumelo/raw/ringtone"))
								...
								Intent resultIntent = new Intent(context, net.aloogle.apps.acasadocogumelo.activity.SplashScreen.class);
								...
								stackBuilder.addParentStack(net.aloogle.apps.acasadocogumelo.activity.SplashScreen.class);
