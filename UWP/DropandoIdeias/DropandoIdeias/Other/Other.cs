...
namespace DropandoIdeias.Other
{
    public static class Other
    {
        public static string defaultUrl = "http://apps.aloogle.net/blogapp/wordpress/";
        public static SQLiteConnection objConn = new SQLiteConnection("DropandoIdeias.db");
        ...
        public static void VisibleCollapsed(UIElement[] visible, UIElement[] collapsed)
        {
            foreach(UIElement v in visible)
            {
                v.Visibility = Visibility.Visible;
            }

            foreach (UIElement c in collapsed)
            {
