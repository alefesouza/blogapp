...
namespace DropandoIdeias.Models
{
    public class PostItem
    {
        ...
        public PostItem(string Title, string Description, string Post, string Image, string Url, string Comments, string Date, string Author)
        {
            ...
            {
                this.Comments = Comments + " " + Other.Other.loader.GetString("Comment");
            }
            else
            {
                this.Comments = Comments + " " + Other.Other.loader.GetString("Comments");
            }
            this.Date = Date;
            this.Author = Author;
        }
