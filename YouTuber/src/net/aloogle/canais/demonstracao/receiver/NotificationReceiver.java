package net.aloogle.canais.demonstracao.receiver;
...
import net.aloogle.canais.demonstracao.activity.SplashScreen;
...
public class NotificationReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if (action.equals("net.aloogle.canais.demonstracao.UPDATE_STATUS")) {
				...
				if (!receivedTitle.equals("")) {
					if (preferences.getInt("count", 0) == 1) {
						...
						NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
							...
							.setAutoCancel(true)
							.setLights(0xFFF20038, 1500, 2500)
						...
						Intent resultIntent = new Intent(context, net.aloogle.canais.demonstracao.activity.SplashScreen.class);
						resultIntent.putExtra("id", receivedId);
						resultIntent.putExtra("fromnotification", true);

						TaskStackBuilder stackBuilder = TaskStackBuilder.create(context);

						stackBuilder.addParentStack(net.aloogle.canais.demonstracao.activity.SplashScreen.class);
