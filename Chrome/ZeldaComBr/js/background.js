chrome.omnibox.onInputChanged.addListener(
	...
	suggest([{
				content : " " + text,
				description : "Digite sua busca no Zelda.com.br"
			}, {
				content : "Zelda U",
				description : "Zelda U"
			}, {
				content : "Majora's Mask 3D",
				description : "Majora's Mask 3D"
			}, {
				content : "Hyrule Warrios",
				description : "Hyrule Warrios"
			}, {
				content : "Mario Kart",
...
chrome.omnibox.onInputEntered.addListener(
	function (text) {
	window.open('http://www.zelda.com.br/search/node/' + text);
});
...
function notifLatestPosts() {
	$.ajax({
		url : 'http://apps.aloogle.net/blogapp/chromenotification.php?site=zeldacombr&list=true',
...
function notifPost() {
	$.ajax({
		url : 'http://apps.aloogle.net/blogapp/chromenotification.php?site=zeldacombr',
		success : function (json) {
